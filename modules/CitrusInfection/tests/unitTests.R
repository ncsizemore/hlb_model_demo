...
test_dir("C:/Users/ncsizemore/Documents/florida-hlb-model/spades_model/modules/CitrusInfection/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/ncsizemore/Documents/florida-hlb-model/spades_model/modules/CitrusInfection/tests/testthat/test-template.R")
