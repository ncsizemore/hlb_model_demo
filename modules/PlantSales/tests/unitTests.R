...
test_dir("H:/Documents/florida-hlb-model/spades_model/modules/PlantSales/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("H:/Documents/florida-hlb-model/spades_model/modules/PlantSales/tests/testthat/test-template.R")
