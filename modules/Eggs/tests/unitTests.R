...
test_dir("H:/Documents/florida-hlb-model/spades_model/modules/Eggs/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("H:/Documents/florida-hlb-model/spades_model/modules/Eggs/tests/testthat/test-template.R")
